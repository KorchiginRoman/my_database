...
INSERT INTO 
	...
	('Дарт Плэгас', 6, 4, 448, 1, 0),
	('Писатель и балерина', 7, 5, 352, 2, 0),
	('Дети капитана Гранта', 8, 5, 640, 3, 0),
	('Сорок пять', 9, 5, 768, 1, 0),
	('Сказки Арамиса', 10, 2, 480, 1, 223), 
	('Красношейка', 5, 4, 480, 4, 400),
	('Михаил Строгов, или курьер царя', 2, 2, 480, 1, 0),
	('Горбун. роман в 2т. T.1.Удар Невера', 2, 2, 448, 1, 351),
	('Горбун. роман в 2т. T.2.Клятва Лагардера', 2, 2, 512, 1, 351 ),
	('Романтические приключения Джона Кемпа', 2, 2, 448, 1, 397),
...
INSERT INTO 
	...
	( 'Завещение', 1940),
	( 'Черные орхидеи', 1941),
	( 'Гостиница тринадцати повешенных', 1866),
	( '«Доро́га во Фраанцию», также «Возвращение на родину»', 1887),
	( 'Граф де Шантелен', 1864),
	( 'Дарт Плэгас', 2012),
